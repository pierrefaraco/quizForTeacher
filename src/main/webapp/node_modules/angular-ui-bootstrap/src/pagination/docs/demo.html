<div ng-controller="PaginationDemoCtrl">
	...
	<uib-pagination direction-links="false" boundary-links="true"
		total-items="totalItems" ng-model="currentPage"></uib-pagination>
	<uib-pagination direction-links="false" total-items="totalItems"
		ng-model="currentPage" num-pages="smallnumPages"></uib-pagination>
	...
	<uib-pagination total-items="bigTotalItems" ng-model="bigCurrentPage"
	...
	<h6>
		<code>boundary-link-numbers</code>
		set to
		<code>true</code>
		and
		<code>rotate</code>
	...
	<uib-pagination total-items="bigTotalItems" ng-model="bigCurrentPage"
		max-size="maxSize" class="pagination-sm" boundary-link-numbers="true"></uib-pagination>
	<h6>
		<code>boundary-link-numbers</code>
		set to
		<code>true</code>
