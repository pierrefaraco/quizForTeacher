...
<div ng-controller="DropdownCtrl">
	...
	<span uib-dropdown on-toggle="toggled(open)"> <a href
		id="simple-dropdown" uib-dropdown-toggle> Click me for a dropdown,
			yo! </a>
	...
	<div class="btn-group" uib-dropdown>
		...
		<ul class="dropdown-menu" uib-dropdown-menu
			template-url="dropdown.html" aria-labelledby="button-template-url">
		</ul>
	</div>
	...
	<p>
		<button type="button" class="btn btn-default btn-sm"
			ng-click="toggleDropdown($event)">Toggle button dropdown</button>
	...
	<div id="dropdown-scrollable-container"
		...
		<div id="dropdown-long-content">
			<div id="dropdown-hidden-container">
				...
				<div class="btn-group" uib-dropdown dropdown-append-to-body>
					<button id="btn-append-to-to-body" type="button"
						class="btn btn-primary" uib-dropdown-toggle>
						Dropdown on Body <span class="caret"></span>
					</button>
					<ul class="dropdown-menu" uib-dropdown-menu role="menu"
