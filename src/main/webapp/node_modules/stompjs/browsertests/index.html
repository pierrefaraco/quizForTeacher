...
<body>
	<section>
		...
		<section>
			<p>Tests requires that a Stomp Server accepting WebSocket
				protocol is running with the configuration:</p>
			<ul>
				<li>URL: <span id="test_url"></span>
				<li>Destination: <span id="test_destination"></span>
				<li>User: <span id="test_login"></span> / <span
					id="test_password"></span>
			</ul>
			<p>
				These values can be configured in <a href="unit/config.js">unit/config.js</a>
		</section>
